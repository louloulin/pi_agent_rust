...
fn tool_result_inline_parts(result: &pi_ai::model::ToolResultMessage) -> Vec<GeminiPart> {
    result
        .content
        .iter()
        .filter_map(|block| match block {
...
mod tests {
    ...
    fn collect_stream_items_from_body(body: &str) -> Vec<Result<StreamEvent>> {
        ...
        let context = Context::owned(
            None,
            vec![Message::User(pi_ai::model::UserMessage {
    ...
    fn test_stream_rejects_transport_eof_before_finish_reason() {
        ...
        assert!(
            pi_error::is_retryable_error(&error, None, None),
    ...
    fn test_build_request_with_tools() {
        ...
        let options = pi_ai::provider::StreamOptions::default();
    ...
    fn test_convert_tool_result_with_media_attaches_inline_turn() {
        let message = Message::tool_result(pi_ai::model::ToolResultMessage {
        ...
        let media_only = Message::tool_result(pi_ai::model::ToolResultMessage {
            tool_call_id: "call_media".to_string(),
            tool_name: "read_media".to_string(),
            content: vec![ContentBlock::Media(pi_ai::model::MediaContent {
                data: "AAAA".to_string(),
        ...
        let text_only = Message::tool_result(pi_ai::model::ToolResultMessage {
    ...
    fn test_convert_custom_message() {
        let message = Message::Custom(pi_ai::model::CustomMessage {
    ...
    fn test_build_request_full_conversation() {
        ...
        let context = Context::owned(
            ...
            vec![
                ...
                Message::tool_result(pi_ai::model::ToolResultMessage {
