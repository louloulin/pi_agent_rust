        ...
        if !summary.is_empty() {
            self.messages.push((
                Message::User(pi_ai::model::UserMessage {
                    content: pi_ai::model::UserContent::Text(
...
pub(crate) fn session_message_to_model(message: &SessionMessage) -> Option<Message> {
    match message {
        ...
        SessionMessage::Custom {
            ...
            details,
            timestamp,
        } => Some(Message::Custom(pi_ai::model::CustomMessage {
            content: content.clone(),
...
mod tests {
    use super::*;
    use pi_ai::model::{Cost, StopReason, Usage};
    ...
    fn test_assistant_with_tool_calls_round_trip() {
        ...
        let assistant = AssistantMessage {
            content: vec![
                ...
                ContentBlock::ToolCall(pi_ai::model::ToolCall {
