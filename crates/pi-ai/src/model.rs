...
pub fn sanitize_image_mime_type(mime_type: &str) -> String {
...
pub const MAX_MEDIA_NAME_LEN: usize = 120;
...
pub fn sanitize_media_name(name: &str) -> Option<String> {
...
impl MediaContent {
    ...
    pub fn input_type(&self) -> Option<InputType> {
        ...
        match top_level {
            "video" => Some(InputType::Video),
            "audio" => Some(InputType::Audio),
            _ => None,
        }
    }
    ...
    fn content_block_media_roundtrip_and_wire_shape() {
        ...
        match parsed {
            ContentBlock::Media(media) => {
                ...
                assert_eq!(media.input_type(), Some(InputType::Video));
        ...
        assert_eq!(unnamed.input_type(), Some(InputType::Audio));
