...
use pi_ai::model::{AssistantMessageEvent, ContentBlock};
...
fn resolve_acp_thinking_level(
    ...
    let requested = config
        ...
        .unwrap_or(pi_ai::model::ThinkingLevel::XHigh);
...
enum RuntimeConfigOption {
    ...
    ThinkingLevel(pi_ai::model::ThinkingLevel),
}
...
const fn map_stop_reason(reason: pi_ai::model::StopReason) -> &'static str {
...
mod tests {
    ...
    fn resolve_acp_thinking_level_defaults_to_highest_supported_level() {
        ...
        assert_eq!(thinking, pi_ai::model::ThinkingLevel::XHigh);
    }
    ...
    fn resolve_acp_thinking_level_clamps_non_reasoning_models_to_off() {
        ...
        assert_eq!(thinking, pi_ai::model::ThinkingLevel::Off);
    }
    ...
    fn parse_config_option_accepts_thinking_aliases() {
        for name in [
            ...
            assert!(matches!(
                option,
                RuntimeConfigOption::ThinkingLevel(pi_ai::model::ThinkingLevel::Off)
            ));
        }
    }
    ...
    fn parse_config_option_accepts_numeric_value() {
        ...
        assert!(matches!(
            option,
            RuntimeConfigOption::ThinkingLevel(pi_ai::model::ThinkingLevel::High)
        ));
    }
