...
/// Return a compact UTC timestamp without coupling the core crate to the
/// coding-agent runtime's validation module.
fn chrono_now_iso() -> String {
    ...
    let (year, month, day) = {
        ...
        let month_lengths = [31, if (year % 4 == 0 && year % 100 != 0) || year % 400 == 0 { 29 } else { 28 }, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31];
        let mut month = 1;
