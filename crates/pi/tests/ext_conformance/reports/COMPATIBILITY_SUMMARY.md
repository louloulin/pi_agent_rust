...
|---|---:|---|
| Extension conformance corpus | 206/223 pass (92.4%) | `tests/ext_conformance/reports/conformance/conformance_report.json` |
...
|---|---:|---:|---:|
| Extension pass count | 187 | 206 | +19 |
| Extension fail count | 36 | 17 | -19 |
| Extension pass rate | 83.9% | 92.4% | +8.5 pp |
...
## Remaining Failure Buckets (17 total)
...
| Host-read policy denials (outside extension root) | 3 | `npm/ogulcancelik-pi-sketch`, `npm/pi-interview`, `third-party/ogulcancelik-pi-sketch` |
