...
use pi_ai::provider::{CacheRetention, Context, Provider, StreamOptions, ToolDef};
...
mod tests {
    ...
    fn test_build_request_includes_system_tools_and_thinking() {
        ...
        let options = StreamOptions {
            ...
            thinking_budgets: Some(pi_ai::provider::ThinkingBudgets {
                minimal: 1024,
                low: 2048,
                medium: 9000,
                high: 16384,
    ...
    fn unknown_anthropic_stop_reason_is_an_explicit_protocol_error() {
        ...
        runtime.block_on(async {
            ...
            let mut state = StreamState::new(
                pi_ai::sse::SseStream::new(Box::pin(byte_stream)),
    ...
    fn test_before_provider_request_rewrite_reaches_wire() {
        ...
        let options = StreamOptions {
            api_key: Some("sk-ant-test-key".to_string()),
            before_provider_request: Some(pi_ai::provider::BeforeProviderRequestHook::new(
                |event| {
                    Box::pin(async move {
