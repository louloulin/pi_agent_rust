...
pub use pi_agent_core::current_time::TimeSnapshot;
...
mod tests {
    ...
    #[test]
    fn snapshot_domain_is_owned_by_agent_core() {
        ...
        let snapshot = pi_agent_core::current_time::TimeSnapshot::from_instants(
            utc,
